    ...
    <ul class="side-nav">
        ...
        <li><?=
            $this->Form->postLink($this->Html->image('/img/remove.png', ['width' => '16', 'height' => '16']) . ' '
                    . __('Delete'), ['action' => 'delete', $keyword->id], ['escape' => false, 'confirm' => __('Are you sure you want to delete # {0}?', $keyword->name)]);
            ?></li>
        <li><?= $this->Html->link($this->Html->image('/img/keyword.png', ['width' => '16', 'height' => '16']) . ' ' . __('List Keywords'), ['action' => 'index'], ['escape' => false]) ?></li>
    </ul>
</nav>
