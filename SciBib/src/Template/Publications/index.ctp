...
<div class="">
    ...
    if (!$user['active'] && !$hideFilterHeader && !$isEmbedded['isEmbedded']) {
        ?>
            ...
            <table class="publicationListEntry table-striped table-hover">
                <tbody>
            ...
            if (array_key_exists($loweredType, $typeColors))
                ...
                if ($year !== $publication->year) {
                    echo '</tbody></table> <table class="publicationListEntry table-striped table-hover"> <tbody>' ;
                    $year = $publication->year;
                    echo '<h3>' . $publication->year . '</h3>';
                }
            ?>
                ...
                <tr>
                    ...
                    <td class="publicationInfo">
                        <!--authors listed-->
                        <p class="publicationAuthors">
                        <?php
