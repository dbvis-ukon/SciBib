...
class EmailSender
{
     ...
     * @return array email send result
     */
    public function sendAddPasswordEmail(EntityInterface $user, Email $email = null, $template = 'CakeDC/Users.new_password')
    {
        $this
            ->getMailer(
                'CakeDC/Users.Users',
            ...
            ->send('addPassword', [$user, $template]);
    }
