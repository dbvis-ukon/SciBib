...
<div class="actions columns large-2 medium-3">
    ...
    <ul class="side-nav">
        <li><?= $this->Html->link($this->Html->image('/img/remove.png', ['width' => '16', 'height' => '16']) . ' ' . __('Delete User'), ['action' => 'delete', $Users->id], ['confirm' => __d('Users', 'Are you sure you want to delete # {0}?', $Users->username), 'escape' => false]) ?></li>
    </ul>
</div>
